...
#define vdNoVideoDevice 0x2110 /*Error - no video device was found */
#define vdAlreadyStarted 0x2111 /*Error - Video tool set already started */
#define vdInvalidSelector 0x2112 /*Error - an invalid selector was specified */
#define vdInvalidParam 0x2113 /*Error - an invalid parameter was specified */
#define vdUnImplemented 0x21FF /*Error - an unimplemented tool set routine was called */
...
extern pascal Word VDKeyGetRCol () inline(0x1021,dispatcher);
extern pascal Word VDKeyGetGCol () inline(0x1121,dispatcher);
extern pascal Word VDKeyGetBCol () inline(0x1221,dispatcher);
